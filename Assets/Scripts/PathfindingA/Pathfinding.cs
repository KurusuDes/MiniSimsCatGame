...
public class Pathfinding
{
    ...
    public Pathfinding(bool showDebug,int width, int height,int cellsize,Vector3 originPoint)
    {
        Instance = this;
        grid = new Grid<PathNode>(showDebug,width, height, cellsize, originPoint, (Grid<PathNode> g, int x, int y) => new PathNode(g, x, y));
    }
